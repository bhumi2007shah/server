...
ALTER TABLE JOB_CANDIDATE_MAPPING
ADD COLUMN JOB_STAGE_STEP_ID INTEGER REFERENCES JOB_STAGE_STEP(ID),
...
UPDATE JOB_CANDIDATE_MAPPING
SET JOB_STAGE_STEP_ID = (
SELECT JOB_STAGE_STEP.ID
FROM JOB_STAGE_STEP, JOB, COMPANY_STAGE_STEP
WHERE JOB_STAGE_STEP.JOB_ID = JOB.ID
AND JOB.COMPANY_ID = COMPANY_STAGE_STEP.COMPANY_ID
AND COMPANY_STAGE_STEP.STEP = 'Source'
